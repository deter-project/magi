...
intf = [ ]
clients = [ ]
number_of_clients = 66
for i in range(0,number_of_clients):
	#print i
	subs.append(topdl.Substrate('link'+str(i),topdl.Capacity(100.0, 'max')))
...
for index,elem_name in enumerate(clients):
	if index <33:
		...
		inf_list.append(inf)
		inf = topdl.Interface(name='inf001', substrate=['link'+str(index+33)])
		inf_list.append(inf)
